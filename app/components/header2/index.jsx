  ...
  >
    <div className="header-inner">
      <div className="header-inner-wrap">
        <div id="site-logo">
          <Link href="/" rel="home">
            <img id="logo-header " className='mt-2 mb-5 d-none d-md-flex ' src="/assets/images/header2.png" alt="" style={{height:"100%",width:"190px"}} />
            <img id="logo-header-mobile" className='mt-2 mb-5 d-flex d-md-none ' src="/assets/images/Header3.png" alt="" style={{height:"100%",width:"190px"}} />
          </Link>
        </div>
