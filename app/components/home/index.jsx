                      ...
                      <div className="col-12">
                        <div className="slider-content">
                          <h1 className="wow fadeInUp">
                            The <span>#1</span> site real estate professionals
                            trust*
                          </h1>
                ...
                <div className="row">
                  <div className="col-12">
                    <div className="heading-section text-center">
                      <h2 className="wow fadeInUp">A Message from Our CEO</h2>
                      <div className="text wow fadeInUp">
                    ...
                    <div className="wrap">
                      <Swiper
                        ...
                        breakpoints={{
                          ...
                          1024: {
                            // Adjust breakpoint to avoid overlap with 868
                            slidesPerView: 5,
                            spaceBetween: 40,
                          },
                        }}
                        ...
                        <div className="col-xl-3 col-md-6">
                          <div className="number-counter style-1">
                            ...
                            <p className="text-content">
                              Pellentesque egestas elementum egestas faucibus
                              sem.
                            </p>
                          </div>
                        </div>
                    ...
                    <div className="content-left widget-menu-tab">
                      <div className="box-icon has-bg item-title active">
                        ...
                        <div className="content">
                          ...
                          <p>
                            Sumo petentium ut per, at his wisim utinam
                            adipiscing. Est ei graeco Lorem ipsum dolor sit
                    ...
                    <div className="widget-content-tab">
                      <div className="widget-content-inner active">
                        <div className="img-right">
                          <img
                            src="/assets/images/section/works-step-1.jpg"
                            alt=""
                          />
                        </div>
                      </div>
                ...
                <div className="row justify-between">
                  <div className="col-md-6">
                    <div className="image wow fadeInLeft">
                      <img
                        src="/assets/images/section/luxury-home-2.jpg"
                        alt=""
                      />
                      <div className="box">
                        <div className="icon">
                  ...
                  <div className="col-xl-5 col-md-6">
                    <div className="content">
                      ...
                      <div className="text-content wow fadeInUp">
                        Pellentesque egestas elementum egestas faucibus sem.
                        Velit nunc egestas ut morbi. Leo diam diam nibh eget
                        fermentum massa pretium. Mi mauris nulla ac dictum ut
                        mauris non.
                      </div>
                      <ul>
